  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        ...
        children: const [
          Center(child: Text('네하담 서비스 이용약관')),
          Text(
              '제 1조 (목적)\n본 약관은 네하담(이하 “회사”라 함)이 운영하는 네하담 애플리케이션(이하 “앱”이라 함)에서 제공하는 제반 서비스의 이용과 관련하여 회사와 이용자 및 이용자 간의 권리, 의무 및 책임, 기타 필요한 사항을 규정함을 목적으로 합니다.\n'),
          Text(
              '제 2조 (정의)\n1. 네하담은 사진변환 중개 서비스(이하 “서비스”라 함)로, 사진변환을 요청하는 자(이하 “고객”이라 함)와 사진변환을 수행하는 자(이하 “공급자”라 함)를 연결해주는 중개 서비스를 제공하며, 구체적인 내용은 제 5조에 따릅니다.\n2. 회원: 회사의 서비스에 접속하여 본 약관에 따라 회사가 제공하는 서비스를 이용하는 회원을 말합니다.\n3. 고객: 서비스 이용 회원 중 사진변환을 요청, 도와줄 수 있는 리스너를 연결 받는 회원을 말합니다.\n4. 리스너: 서비스 이용 회원 중 도움이 필요한 고객과 연결되어 도움을 주는 회원을 말합니다.\n'),
...
class mypagerule2 extends StatelessWidget {
  const mypagerule2({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: ListView(
          scrollDirection: Axis.vertical,
          children: const [
            Center(child: Text('개인정보처리방침')),
            Text(
                "<네하담>(이하 '네하담 앱')은(는) 개인정보보호법에 따라 이용자의 개인정보 보호 및 권익을 보호하고 개인정보와 관련한 이용자의 고충을 원활하게 처리할 수 있도록 다음과 같은 처리방침을 두고 있습니다."),
            Text(
                "\n<네하담>('네하담 앱') 은(는) 회사는 개인정보처리방침을 개정하는 경우 웹사이트 공지사항(또는 개별공지)을 통하여 공지할 것입니다."),
            Text('\n○ 본 방침은부터 2022년 8월 1일부터 시행됩니다.'),
            Text(
                "\n1. 개인정보의 처리 목적 <네하담>('앱 다운로드'이하 '네하담 앱')은(는) 개인정보를 다음의 목적을 위해 처리합니다. 처리한 개인정보는 다음의 목적이외의 용도로는 사용되지 않으며 이용 목적이 변경될 시에는 사전동의를 구할 예정입니다."),
            Text(
            ...
            Text(
                "\n8. 개인정보 보호책임자 작성\n1 네하담('앱 다운로드’이하 '네하담 앱) 은(는) 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의 불만처리 및 피해구제 등을 위하 여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.\n네하담은 정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴 것 입니다."),
            Text(
                '\n9. 개인정보 처리방침 변경\n①이 개인정보처리방침은 시행일로부터 적용되며, 법령 및 방침에 따른 변경내용의 추가, 삭제 및 정정이 있는 경우에는 변경사항의 시행 7일 전부터 공지사항을 통하여 고지할 것입니다.'),
            Text(
                '\n10. 개인정보의 안정성 확보 조치\n네하담은 개인정보보호법 제29조에 따라 다음과 같이 안전성 확보에 필요한 기술적/관리적 및 물리적 조치를 하고 있습니다.\n1) 개인정보 취급 직원의 최소화 및 교육\n개인정보를 취급하는 직원을 지정하고 담당자에 한정시켜 최소화하여 개인정보를 관리하는 대책을 시행하고 있습니다.\n2) 해킹 등에 대비한 기술적 대책\n네하담은 해킹이나 컴퓨터 바이러스 등에 의한 개인정보 유출 및 훼손을 막기 위하여 보안프로그램을 설치하고 주기적인 갱신·점검을 하며 외부로부터 접근이 통제된 구역에 시스템을 설치하고 기술적/물리적으로 감시 및 차단하고 있습니다.\n3) 개인정보의 암호화\n이용자의 개인정보는 비밀번호는 암호화되어 저장 및 관리되고 있어, 본인만이 알 수 있으며 중요한 데이터는 파일 및 전송 데이터를 암호화 하거나 파일 잠금 기능을 사용하는 등의 별도 보안기능을 사용하고 있습니다.\n4) 접속기록의 보관 및 위변조 방지\n개인정보처리시스템에 접속한 기록을 최소 6개월 이상 보관, 관리하고 있으며, 접속 기록이 위변조 및 도난, 분실되지 않도록 보안기능 사용하고 있습니다.\n5) 개인정보에 대한 접근 제한\n개인정보를 처리하는 데이터베이스시스템에 대한 접근권한의 부여,변경,말소를 통하여 개인정보에 대한 접근통제를 위하여 필요한 조치를 하고 있으며 침입차단시스템을 이용하여 외부로부터의 무단 접근을 통제하고 있습니다.\n6) 문서보안을 위한 잠금장치 사용\n개인정보가 포함된 서류, 보조저장매체 등을 잠금장치가 있는 안전한 장소에 보관하고 있습니다.\n7) 비인가자에 대한 출입 통제\n개인정보를 보관하고 있는 물리적 보관 장소를 별도로 두고 이에 대해 출입통제 절차를 수립, 운영하고 있습니다.'),
          ],
        ));
  }
}
